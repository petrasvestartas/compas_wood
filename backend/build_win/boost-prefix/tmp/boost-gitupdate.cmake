...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/IBOIS57/_Code/Software/Python/compas_wood/backend/build_win/boost-prefix/src/boost'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/IBOIS57/_Code/Software/Python/compas_wood/backend/build_win/boost-prefix/src/boost'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
