...
#include "stdafx_pybind11.h" // CMakeLists link: PRIVATE "${CMAKE_SOURCE_DIR}/src/compas_wood/include/"
#include "wood_globals.h"    //  CMakeLists link:PRIVATE "${CMAKE_SOURCE_DIR}/src/compas_wood/wood/include/"
