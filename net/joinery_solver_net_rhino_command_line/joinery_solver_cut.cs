...
{
    public class joinery_solver_cut : Command
    {
        public joinery_solver_cut()
        {
            Instance = this;
        }

        public static joinery_solver_cut Instance { get; private set; }
        public override string EnglishName => "joinery_solver_toolpath_cut";
