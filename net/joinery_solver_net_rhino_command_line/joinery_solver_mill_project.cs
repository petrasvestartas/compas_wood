...
{
    public class joinery_solver_mill_project : Command
    {
        public joinery_solver_mill_project()
        {
        ...
        public static joinery_solver_mill_project Instance { get; private set; }

        ///<returns>The command name as it appears on the Rhino command line.</returns>
        public override string EnglishName => "joinery_solver_toolpath_mill_project";
