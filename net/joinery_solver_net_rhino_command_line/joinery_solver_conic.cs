...
{
    public class joinery_solver_conic : Command
    {
        public joinery_solver_conic()
        {
            Instance = this;
        }

        public static joinery_solver_conic Instance { get; private set; }
        public override string EnglishName => "joinery_solver_toolpath_conic";
