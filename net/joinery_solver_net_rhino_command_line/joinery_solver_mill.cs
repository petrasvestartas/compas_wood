...
{
    public class joinery_solver_mill : Command
    {
        public joinery_solver_mill()
        {
        ...
        public static joinery_solver_mill Instance { get; private set; }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            //rhino_object.UserDictionary.Set("cut", cut);
