...
{
    public class joinery_solver_slice : Command
    {
        public joinery_solver_slice()
        {
            Instance = this;
        }


        public static joinery_solver_slice Instance { get; private set; }
        public override string EnglishName => "joinery_solver_toolpath_slice";
