    ...
    public class solver_component : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            try
            {
                ...
                int search_type = 0;
                DA.GetData(2, ref search_type);
                int output_type = 1;
                DA.GetData(3, ref output_type);
        ...
        division_length, 0.5,50
                ...
                //watch.Start();
                joinery_solver_net.Test.pinvoke_get_connection_zones(ref out_polylines, (joinery_solver_net.Data)(data), joint_params, search_type, 300, 0.6, output_type);
