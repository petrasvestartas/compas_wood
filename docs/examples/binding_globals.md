...
Example demonstrating global settings and parameters.

```python
from compas_wood.binding import wood_globals

# Set distance squared parameter
wood_globals.distance_squared = 10

# Set joint rotation parameters
...
The `joints_parameters_and_types` property provides access to the joinery library parameters:
