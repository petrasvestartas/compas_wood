...
class connections_zones(component):
    def RunScript(self, _polylines, _id, _vectors, _joint_types, _three_valence, _adjacency, _params, _scale, _output, _search, _extension):
        # ==============================================================================
        # input
        # ==============================================================================
        output_polylines = []
        ...
        if(_joint_types.DataCount != 0):
            treehelpers.tree_to_list(_joint_types)
        ...
        for i in range(0, len(result)):
            for j in range(0, len(result[i])):
                    _polylines_out.Add(conversions.polyline_to_rhino(result[i][j]), gh.Kernel.Data.GH_Path(i))
