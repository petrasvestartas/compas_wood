...
// angle = atan(s / c)
///////////////////////////////////////////////////////////////////////////////
inline float Matrix2::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
inline Vector3 Matrix3::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::invertEuclidean()
{
...
//  [ 0 | 1 ]     [  0   +     1     ]
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::invertAffine()
{
	// R^-1
...
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::invertProjective()
{
	// partition
...
// M^-1 = adj(M) / det(M)
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::invertGeneral()
{
...
///////////////////////////////////////////////////////////////////////////////
inline float Matrix4::getCofactor(float m0, float m1, float m2,
	float m3, float m4, float m5,
	float m6, float m7, float m8) const
{
...
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::rotate(float angle, const Vector3& axis)
{
...
///////////////////////////////////////////////////////////////////////////////
inline Matrix4& Matrix4::lookAt(const Vector3& target)
{
...
inline Matrix4& Matrix4::lookAt(const Vector3& target, const Vector3& upVec)
{
	// compute forward vector and normalize
	Vector3 position = Vector3(m[12], m[13], m[14]);
	Vector3 forward = target - position;
...
inline Matrix4& Matrix4::lookAt(float tx, float ty, float tz)
{
	return lookAt(Vector3(tx, ty, tz));
}

inline Matrix4& Matrix4::lookAt(float tx, float ty, float tz, float ux, float uy, float uz)
{
...
///////////////////////////////////////////////////////////////////////////////
inline Vector3 Matrix4::getAngle() const
{
	float pitch, yaw, roll;         // 3 angles
