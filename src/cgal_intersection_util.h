...
namespace cgal_intersection_util {
	...
	inline bool QuadFromLineAndTopBottomPlanes(IK::Plane_3& collision_face, IK::Segment_3& l, IK::Plane_3& pl0, IK::Plane_3& pl1, CGAL_Polyline& quad) {
		...
		IK::Point_3 p0; cgal_intersection_util::Intersect(line_pl0_EK, pl0, collision_face, p0);
		IK::Point_3 p1; cgal_intersection_util::Intersect(line_pl0_EK, pl1, collision_face, p1);
		IK::Point_3 p2; cgal_intersection_util::Intersect(line_pl1_EK, pl1, collision_face, p2);
		IK::Point_3 p3; cgal_intersection_util::Intersect(line_pl1_EK, pl0, collision_face, p3);
		quad = { p0 ,p1,p2,p3,p0 };
	...
	inline void plane_4_planes(IK::Plane_3& mainPlane, IK::Plane_3(&sequence_of_planes)[4], CGAL_Polyline& quad) {
		...
		IK::Point_3 p0; cgal_intersection_util::Intersect(sequence_of_planes[0], sequence_of_planes[1], mainPlane, p0);
		IK::Point_3 p1; cgal_intersection_util::Intersect(sequence_of_planes[1], sequence_of_planes[2], mainPlane, p1);
		IK::Point_3 p2; cgal_intersection_util::Intersect(sequence_of_planes[2], sequence_of_planes[3], mainPlane, p2);
		IK::Point_3 p3; cgal_intersection_util::Intersect(sequence_of_planes[3], sequence_of_planes[0], mainPlane, p3);
		quad = { p0 ,p1,p2,p3,p0 };
	...
	inline bool Plane4LinesIntersection(IK::Plane_3& plane, IK::Segment_3& l0, IK::Segment_3& l1, IK::Segment_3& l2, IK::Segment_3& l3, CGAL_Polyline& output) {
		...
		IK::Point_3 p0; cgal_intersection_util::Intersect(l0, plane, p0);
		IK::Point_3 p1; cgal_intersection_util::Intersect(l1, plane, p1);
		IK::Point_3 p2; cgal_intersection_util::Intersect(l2, plane, p2);
		IK::Point_3 p3; cgal_intersection_util::Intersect(l3, plane, p3);
