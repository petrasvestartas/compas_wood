...
namespace cgal_polyline_util
{
    ...
    inline void AveragePlane(const CGAL_Polyline &polyline, IK::Vector_3 (&planeAxes)[4], bool closed = true)
    {
        // Origin
    ...
    inline bool PlanePolylineIntersection(const CGAL_Polyline &polyline, IK::Plane_3 &plane, std::vector<IK::Point_3> &points, std::vector<int> &edge_ids)
    {
